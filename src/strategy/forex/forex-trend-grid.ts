                  ...
                  if (key.includes('/') && pos.positionId) {
                    ...
                    if (!existing) {
                      ...
                      await ForexArbStrategy.create({
                        ...
                        positionOpen: true,
                        active: true,
                        legs: [{ symbol: key, side: sideUpper, exchangeId: 'ctrader', price: ticker.bid, volume: lotSize, amount: volUnits }],
                ...
                if (Math.abs(deltaPips) >= 0.8) {
                  ...
                  try {
                    ...
                    const newStrat = await ForexArbStrategy.create({
                      ...
                      positionOpen: true,
                      active: true,
                      legs: [{ symbol: sym, side: autoSide, exchangeId: 'ctrader', price: entryPrice, volume: lotSize, amount: volUnits }],
                      positionSize: volUnits,
                      positionVolume: lotSize,
