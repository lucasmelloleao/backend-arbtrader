...
export interface IIcMarketsStrategy extends mongoose.Document {
...
const IcMarketsStrategySchema = new mongoose.Schema(
  {
...
IcMarketsStrategySchema.index({ userId: 1, symbol: 1 });

export default mongoose.models.IcMarketsStrategy || mongoose.model<IIcMarketsStrategy>('IcMarketsStrategy', IcMarketsStrategySchema);
