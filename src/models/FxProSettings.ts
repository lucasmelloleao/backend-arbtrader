...
export interface IFxProSettings extends mongoose.Document {
  userId: mongoose.Types.ObjectId;
  accountType: 'demo' | 'real';
  accountId: string; // Ex: '10650441'
  ...
  defaultLeverage: number; // Alavancagem padrão (ex: 1000)
...
const FxProSettingsSchema = new mongoose.Schema(
  {
    userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true, unique: true },
    accountType: { type: String, enum: ['demo', 'real'], default: 'demo' },
    accountId: { type: String, default: '10650441' },
    ...
    defaultLeverage: { type: Number, default: 1000 },
...
export default mongoose.models.FxProSettings || mongoose.model<IFxProSettings>('FxProSettings', FxProSettingsSchema);
